    ...
    final filtered = allTransactions.where((tx) {
      switch (_selectedFilter) {
        ...
        case ActivityFilter.sent:
          return tx.type == TransactionType.instantSend || tx.type == TransactionType.protectedSend;
        case ActivityFilter.received:
          return tx.type == TransactionType.instantReceive || tx.type == TransactionType.protectedClaim;
        case ActivityFilter.protected:
          return tx.type == TransactionType.protectedSend ||
